...
public class CCSMountedStorageTypes {
    ...
    public static final RegistryEntry<MountedItemStorageType<?>, IronShulkerBoxMountedStorageType> IRON_SHULKER_BOX = REGISTRATE.mountedItemStorage("iron_shulker_box", IronShulkerBoxMountedStorageType::new)
            .associateBlockTag(CCSTags.ISB_IRON_SHULKER_BOX_MOUNTED_STORAGE)
            .register();
